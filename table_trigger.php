...
$createTables = [
    ...
    "CREATE TABLE sales_returns (
        ...
        refund_method ENUM('cash','credit','bank_transfer','exchange') NOT NULL,
        user_id INT NULL,
        is_deleted TINYINT(1) DEFAULT 0,
        deleted_at TIMESTAMP NULL,
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    ...
    "CREATE TABLE purchase_returns (
        ...
        refund_amount DECIMAL(10,2) NOT NULL,
        refund_method ENUM('cash','credit','bank_transfer', 'exchange') NOT NULL,
        vat_amount decimal(10,2) NULL DEFAULT 0.00,
        discount_adjusted decimal(10,2) NULL DEFAULT 0.00,
        vat_rate_used decimal(5,2) NULL DEFAULT 0.00,
        original_vat_amount decimal(12,2) NULL DEFAULT 0.00,  
        user_id INT NULL,
        is_deleted TINYINT(1) DEFAULT 0,
        deleted_at TIMESTAMP NULL,
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
